...
use crate::{DayType, DiffType, Fields, HourType, MinuteType, MonthType, SecondType, YearType};
...
pub(crate) const fn n_mon(
    ...
    n_day(y, m as MonthType, d, cd, hh, mm, ss)
}

pub(crate) const fn n_hour(
    y: YearType,
    m: DiffType,
    d: DiffType,
    mut cd: DiffType,
    ...
    n_mon(y, m, d, cd, hh as HourType, mm, ss)
}

pub(crate) const fn n_min(
    y: YearType,
    m: DiffType,
    d: DiffType,
    hh: DiffType,
